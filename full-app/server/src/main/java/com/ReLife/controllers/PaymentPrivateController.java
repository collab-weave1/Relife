...
@RestController
@RequestMapping("/api/pvt-payment")
...
public class PaymentPrivateController {
	...
	private static final Logger logger = LoggerFactory.getLogger(PaymentPrivateController.class);
    private final ObjectMapper mapper = new ObjectMapper();
    private final PaymentService service;

    public PaymentPrivateController(PaymentService service) { 
