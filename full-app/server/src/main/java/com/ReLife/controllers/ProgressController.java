...
public class ProgressController {
    ...
    @PostMapping("/{userId}/{badgeKey}")
    public BadgeEvent awardBadge(@PathVariable Long userId, @PathVariable String badgeKey) {
        return badgeService.awardBadge(userId, badgeKey);
    }
}