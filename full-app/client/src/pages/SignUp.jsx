...
const ROLES = [
  ...
  { value: "producer", label: "Producer", description: "Producer administrator" }
];
...
export const SignUp = ({ isDark }) => {
  ...
  const { signUp, upsertProfile } = useAuth();
...
const handleSignup = async (e) => {
    ...
    try {
      ...
      const res = await signUp({ email: formData.email, password: formData.password, role: formData.role });
      ...
      if (!user) {
        setErrors({ submit: "Signup succeeded but no user returned. Please check your email." });
        navigate("/login");
        return;
      }
      ...
      try {
        ...
        setErrors(prev => ({ ...prev, submit: upsertErr?.message ?? "Could not create profile." }));
      }
        ...
        <div className="relative z-10 flex flex-col justify-center p-8 text-white">
          <div className="max-w-md">
            <h1 className="text-5xl font-bold mb-2 leading-tight">
              Join the
              <span className="block bg-gradient-to-r from-green-200 to-blue-200 bg-clip-text text-transparent">Relife Movement</span>
            </h1>
      ...
      <div className="flex-1 lg:w-2/5 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          <div className="space-y-6">
            <div>
              <label className="block text-sm font-semibold mb-3 text-gray-700 dark:text-gray-300">I am a</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 ${
                    errors.firstName ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : "border-gray-200 dark:border-gray-700 focus:border-green-500 dark:focus:border-green-400 focus:ring-green-500/20"
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 ${
                    errors.lastName ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : "border-gray-200 dark:border-gray-700 focus:border-green-500 dark:focus:border-green-400 focus:ring-green-500/20"
                  } p-4 rounded-xl focus:ring-4 transition-all font-medium shadow-sm hover:shadow-md`}
                  placeholder="Doe"
            ...
            <div>
              ...
              <input
                ...
                className={`w-full text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 ${
                  errors.email ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : "border-gray-200 dark:border-gray-700 focus:border-green-500 dark:focus:border-green-400 focus:ring-green-500/20"
                } p-4 rounded-xl focus:ring-4 transition-all font-medium shadow-sm hover:shadow-md`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 ${
                    errors.password ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : "border-gray-200 dark:border-gray-700 focus:border-green-500 dark:focus:border-green-400 focus:ring-green-500/20"
                ...
                <div className="mt-2">
                  <div className="flex items-center gap-2 mb-1">
                    <div className="flex-1 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                      <div className={`h-2 rounded-full transition-all duration-300 ${passwordStrength.color}`} style={{ width: `${(passwordStrength.strength / 5) * 100}%` }}></div>
                    </div>
                    <span className="text-sm font-medium text-gray-600 dark:text-gray-400">{passwordStrength.label}</span>
                  </div>
                </div>
              )}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border-2 ${
                    errors.confirmPassword ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : "border-gray-200 dark:border-gray-700 focus:border-green-500 dark:focus:border-green-400 focus:ring-green-500/20"
                  } p-4 pr-12 rounded-xl focus:ring-4 transition-all font-medium shadow-sm hover:shadow-md`}
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              ...
              <button onClick={() => navigate("/login")} className="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-semibold transition-colors">
                Sign in
              </button>
            </p>
          </div>
